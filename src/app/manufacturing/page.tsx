...
import { Hammer, History, ClipboardList, Trash2, Calendar, Activity, Layers, Hash } from 'lucide-react';
      ...
      <div className="glass-card bg-mesh-gradient rounded-2xl p-6 relative overflow-hidden transition-all duration-300">
        <div className="flex items-start justify-between">
          <div className="space-y-1">
            <h1 className="text-xl font-bold text-text-primary tracking-tight">Manufacturing Operations</h1>
            <p className="text-sm text-text-secondary">Assemble final products from raw materials utilizing BOM recipes.</p>
          </div>
          <div className="flex items-center gap-2 px-3 py-1 bg-accent/10 border border-accent/20 rounded-full">
            <Activity className="w-3.5 h-3.5 text-accent animate-pulse" />
            <span className="text-xs font-semibold text-accent tracking-wide uppercase">Assembly Line</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="glass-card glow-card rounded-2xl p-5 relative overflow-hidden stagger-enter">
          ...
          <div className="flex items-center justify-between relative z-10">
            <span className="text-xs font-bold text-text-secondary uppercase tracking-wider">Total Builds</span>
            <div className="w-7 h-7 bg-accent/10 rounded-lg flex items-center justify-center">
              <Hash className="w-4 h-4 text-accent" />
            </div>
          </div>
          <p className="text-2xl font-black text-text-primary mt-3 stat-number relative z-10">{totalBuilds}</p>
        ...
        <div className="glass-card glow-card rounded-2xl p-5 relative overflow-hidden stagger-enter">
          ...
          <div className="flex items-center justify-between relative z-10">
            <span className="text-xs font-bold text-text-secondary uppercase tracking-wider">Units Manufactured</span>
            <div className="w-7 h-7 bg-success/10 rounded-lg flex items-center justify-center">
              <Layers className="w-4 h-4 text-success" />
            </div>
          </div>
          <p className="text-2xl font-black text-text-primary mt-3 stat-number relative z-10">{totalUnitsManufactured.toLocaleString()}</p>
        ...
        <div className="lg:col-span-1">
          <Card className={`glass-card rounded-2xl p-5 sticky top-24 transition-all duration-300 ${isFormReady ? 'border-accent/30 shadow-lg shadow-accent/5' : ''}`}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-sm font-bold text-text-primary uppercase tracking-wider">Execute Production</h3>
            </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <Card className="glass-card rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-sm font-bold text-text-primary uppercase tracking-wider">Production Log Run History</h3>
            </div>
